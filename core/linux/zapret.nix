    ...
    systemd.services.zapret = {
      ...
      serviceConfig = {
        ...
        EnvironmentFile = pkgs.writeText "zapret-environment" ''
          	  ...
          	  #NFQWS_OPT_DESYNC="--dpi-desync=fake,disorder2
              #--dpi-desync-split-pos=1 --dpi-desync-ttl=0
              #--dpi-desync-fooling=md5sig,badsum --dpi-desync-repeats=6
              #--dpi-desync-any-protocol --dpi-desync-cutoff=d4
              #--dpi-desync-fake-tls=/home/artemson/.config/nix/utils/tls_clienthello_www_google_com.bin
              "
